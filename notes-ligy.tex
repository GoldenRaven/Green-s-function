...
Usually, only several subbands or transverse modes are investigated, which suggests the integrating range to $[-\frac{T}{2}, E_{i}]$.
...
\end{equation}
\subsection{$Tr[\Gamma_{Rq}D_{L\uparrow}(E)D_{L\uparrow}(E+\omega)\Gamma_{Rq}]$}
